 ...
 */
final class Version20241016095756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partage ADD fichier_id INT NOT NULL, DROP nom_fichier');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partage ADD nom_fichier VARCHAR(100) NOT NULL, DROP fichier_id');
    }
}
